<template>
  <nav class="navbar navbar-expand-md navbar-light bg-purple border-bottom-1 container">
    <div class="container">
      <router-link to="/">
        <h1 style="font-size: 20px;">Site</h1>
      </router-link>
      <button class="navbar-toggler" type="button" data-toggle="collapse" data-target="#mainNavbar" aria-controls="mainNavbar" aria-expanded="false" aria-label="Toggle Nav">
